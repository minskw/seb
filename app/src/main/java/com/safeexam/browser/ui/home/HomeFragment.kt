...
class HomeFragment : Fragment() {
    ...
    private fun launchExam(exam: Exam) {
        val intent = Intent(requireContext(), ExamActivity::class.java).apply {
            ...
            putExtra(ExamActivity.EXTRA_EXAM_MAPEL,  exam.mapel)
            putExtra(ExamActivity.EXTRA_EXAM_TANGGAL, exam.tanggal)
            putExtra(ExamActivity.EXTRA_EXAM_WAKTU,  exam.waktu)
            putExtra(ExamActivity.EXTRA_EXAM_DURASI, exam.durasi)
        }
